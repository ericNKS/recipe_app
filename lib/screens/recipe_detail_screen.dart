...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  void initState() {
    super.initState();
    // Preenche os controladores com os dados da receita existente
    _recipeNameController = TextEditingController(text: widget.recipe.name);
    _preparationController =
        TextEditingController(text: widget.recipe.preparationSteps);

    // Adiciona os ingredientes existentes à lista
    _ingredients.addAll(widget.recipe.ingredients);

    // Define a imagem, se existir
  ...
  Future<void> _saveRecipe() async {
    ...
    String? finalImagePath = widget.recipe.imagePath; // Mantém a imagem antiga por padrão

    // Se uma nova imagem foi selecionada, salva ela
    if (_imageFile != null && _imageFile!.path != widget.recipe.imagePath) {
    ...
    final updatedRecipe = Recipe(
      id: widget.recipe.id, // Mantém o ID original
      userId: widget.recipe.userId, // Mantém o UserId original
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.recipe.name), // Mostra o nome original
        actions: [
          IconButton(
